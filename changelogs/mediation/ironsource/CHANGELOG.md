...
#### Removed
* IronSource Banner, Interstitial, and Rewarded adapters
...
* Added support for IronSource SDK version 7.6.0
...
* Added support for IronSource SDK version 7.5.1

## Version 7.4.0.0

#### Updated
* Added support for IronSource SDK version 7.4.0
